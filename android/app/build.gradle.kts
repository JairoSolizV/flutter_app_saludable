...
android {
    namespace = "com.example.flutter_app_saludable"
...
tasks.register("verifyReleaseSecurity") {
    ...
    doLast {
        ...
        check(appIdMatch != null && appIdMatch.groupValues[1] == "com.nutrilife.club") {
            "applicationId debe permanecer com.nutrilife.club"
        }
