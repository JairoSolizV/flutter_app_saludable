  ...
  Future<void> _loadDetails() async {
    try {
      ...
      final results = await Future.wait([
        clubDs.getAnfitrion(widget.club.anfitrionId),
        clubDs.getFotosClub(widget.club.id),
      ]);
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(widget.club.anfitrionNombre,
                    ...
                    _InfoRow(
                        ...
                        title: 'Dirección',
                        value: widget.club.direccion),
                    const SizedBox(height: 16),
                    _InfoRow(
                        icon: LucideIcons.clock,
                        title: 'Horario',
                        value: widget.club.horario),
                    const SizedBox(height: 16),
                    ...
                    if (_loading)
                      ...
                      if (_anfitrion!.telefono.isNotEmpty) ...[
                        _InfoRow(
                          ...
                          isLink: true,
                          onTap: () => launchUrl(
                              Uri.parse('tel:${_anfitrion!.telefono}')),
                        ),
                        const SizedBox(height: 16),
                      ],
